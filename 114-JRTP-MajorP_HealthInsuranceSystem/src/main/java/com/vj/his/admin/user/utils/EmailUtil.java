package com.vj.his.admin.user.utils;
...
public class EmailUtil {
	...
	public void sendEmail(String to, UserModel user) {
	...
	private String getUnlockAccEmailBody(UserModel acc) throws IOException {
